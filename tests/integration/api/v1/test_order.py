...
def test_order_create_read_delete(db):
    ...
    order = OrderCreateSchema(
        address=AddressCreateSchema(street=new_street, post_code=new_post_code, house_number=new_house_number,
                                    country=new_country, town=new_town, first_name=new_first_name,
                                    last_name=new_last_name), user_id=created_user_id)
